...
const val DEBUG_LOCAL_DEMO_URL = "http://192.168.1.100/ampache/public/server/"

const val AMPACHE_DEMO_APIKEY = "demodemo"
const val AMPACHE_DEMO_URL = "https://demo.ampache.dev/server/"

const val DOGMAZIC_USER = "ths6hh"
const val DOGMAZIC_PASSWORD = "8z19xeid0f6b4"
const val DOGMAZIC_URL = "https://play.dogmazic.net/server"

sealed class Servers(val url: String, val user: String = "", val password: String = "", val apiKey: String = "") {
