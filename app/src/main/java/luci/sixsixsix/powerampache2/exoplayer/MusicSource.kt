...
class MusicSource @Inject constructor(private val musicDatabase: MusicRepository) {
                        ...
                        result.data?.let { allSongs ->
                            songs = allSongs.map { song: Song ->
                                MediaMetadata.Builder()
                                    .putString(METADATA_KEY_ARTIST, song.artist.name)
                                    ...
                                    .putString(METADATA_KEY_DISPLAY_SUBTITLE, song.artist.name)
                                    .putString(METADATA_KEY_DISPLAY_DESCRIPTION, song.album.name)
                                    .build()
                            }
